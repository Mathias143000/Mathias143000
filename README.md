...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,bash,docker,postgres,redis,linux,nginx,git,githubactions&theme=light&perline=5" alt="Core stack" />
</p>

### Технологии

- Linux / Ubuntu / Bash / systemd / SSH
- Docker / Docker Compose
- Python / FastAPI / Django REST Framework
- PostgreSQL / Redis
- Prometheus / Grafana / Alertmanager / Zabbix
- Nginx / HTTP / HTTPS / DNS / TCP/IP
- Git / GitHub Actions
- Logging / health checks / basic incident diagnostics
...
Интересуют задачи и подработка в направлениях:
...
- сопровождение backend-сервисов

Предпочтительный формат: удалённо, частичная занятость, проектная работа или гибкий график.
